...
# Vi bruker den innebygde funksjonen round() for å runde av til to desimaler.
# Legg merke til rekkefølgen på verdiene inni parentesen; den første verdien (moon_weight) er det som skal rundes av, den andre (2) er antall desimaler vi ønsker. Verdiene er adskilt med komma (,).

...
beste_brettspill_2025 = ('Panda splash', 'Point salad', 'Drillers')

# Vi kan skrive ut elementer fra tuppelen på 'vanlig' måte
print(beste_brettspill_2025[1])

# Vi kan iterere gjennom elementene i tuppelen på 'vanlig' måte
for spill in beste_brettspill_2025:
    print(spill)
...
#beste_brettspill_2025[3] = "Monopol"
#beste_brettspill_2025.append("Monopol")
#beste_brettspill_2025.pop()

# Vi kan kopiere fra en tuppel til ny variabel. Siden vi kopierer inn en string, vil spill2 være av datatypen string
spill2 = beste_brettspill_2025[1]
print(spill2)

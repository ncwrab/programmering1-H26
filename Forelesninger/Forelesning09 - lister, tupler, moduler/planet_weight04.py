...
while kjør:  # Dette er det samme som while kjør == True:
    ...
    # Før listen med planeter skrives ut, tilføyer vi et valg '0 - tilfeldig planet' og viser det også til brukeren
    ...
    # Hvis ikke brukeren har tastet inn 0, vises den valgte planeten
